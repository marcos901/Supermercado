...
public class CadastroClienteEntrega extends JFrame {
	...
	public CadastroClienteEntrega(String pnome, String ptelefone, String pcpf, String pcep, String pendereco,
			String pnumero, String pbairro, String pponto, String pid, boolean patualizar) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 415, 300);
		contentPane = new JPanel();
		setResizable(false);
